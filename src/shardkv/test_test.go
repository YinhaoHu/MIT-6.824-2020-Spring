...
// Test case #1: Last passed time is 10:06 A.M 18th, March.
...
// Test case #2: Last passed time is 10:06 A.M 18th, March.
...
// Test case #3: Last passed time is 10:06 A.M 18th, March.
...
// Test case #4: Last passed time is 10:06 A.M 18th, March.
func TestMissChange(t *testing.T) {
	...
	cfg.join(2)  // Config#3
	cfg.leave(1) // Config#4
	cfg.leave(0) // Config#5
...
// Test case #5: Last passed time is 10:06 A.M 18th, March.
...
func TestConcurrent2(t *testing.T) {
	...
	cfg.join(0)  // Config#6
	cfg.join(2)  // Config#7
	cfg.leave(1) // Config#8
	time.Sleep(3000 * time.Millisecond)
	cfg.join(1)  // Config#9
	cfg.leave(0) // Config#10
	cfg.leave(2) // Config#11
	time.Sleep(3000 * time.Millisecond)
...
// Anomalies in unreliable network: drop/delay messages

// Test case #7: Last passed time is 10:06 A.M 18th, March.
...
// Test case #8: Last passed time is 10:06 A.M 18th, March.
...
// Test case #9: Last passed time is 10:06 A.M 18th, March.
...
// Test case #10: Last passed time is 10:06 A.M 18th, March.
...
// Test case #11: Last passed time is 10:06 A.M 18th, March.
...
// Test case #12: Last passed time is 10:06 A.M 18th, March.
